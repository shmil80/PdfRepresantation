...
namespace Typography.FontCollections
{
    ...
    public abstract class AltTypefaceSelectorBase
    {
        ...
        public struct SelectedTypeface
        {
    ...
    public static class InstalledTypefaceCollectionExtensions
    {
        ...
        public static MyFunc<IFontStreamSource, Stream> CustomFontStreamLoader;
        ...
        public static Typeface ResolveTypeface(this InstalledTypefaceCollection fontCollection, InstalledTypeface installedFont)
        {
            ...
            {
                using (var fs = installedFont.FontPath.ReadFontStream())
                {
        ...
        public static Typeface ResolveTypefaceFromFile(this InstalledTypefaceCollection fontCollection, IFontStreamSource filename)
        {
            ...
            if (!fontCollection._installedTypefacesByFilenames.TryGetValue(filename, out InstalledTypeface found))
            {
                ...
                //if (File.Exists(filename))
                {
                    ...
                    using (var fs = filename.ReadFontStream())
                    {
