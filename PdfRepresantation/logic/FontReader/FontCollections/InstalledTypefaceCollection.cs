...
namespace Typography.FontCollections
{
    ...
    partial class InstalledTypefaceCollection
    {
        ...
        //----------
        internal Dictionary<IFontStreamSource, InstalledTypeface> _installedTypefacesByFilenames = new Dictionary<IFontStreamSource, InstalledTypeface>();
                ...
                using (Stream stream = src.ReadFontStream())
                {
                    ...
                    if (previewFont.IsFontCollection)
                    {
                        ...
                        for (int i = 0; i < mbCount; ++i)
                        {
                            ...
                            InstalledTypeface instTypeface = AddFontPreview(previewFont.GetMember(i), src);
                    ...
                    {
                        return AddFontPreview(previewFont, src) != null;
                    }
        ...
        public InstalledTypeface AddFontPreview(PreviewFontInfo previewFont, IFontStreamSource srcPath)
        {
